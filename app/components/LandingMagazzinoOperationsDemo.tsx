...
export default function LandingMagazzinoOperationsDemo() {
  ...
  return (
    <div className="rounded-lg bg-zinc-50 p-2 shadow-[0_0_0_1px_rgba(0,0,0,0.02)] md:p-4 dark:bg-zinc-900">
        ...
        {PHASES.map((p, i) => {
          ...
          return (
            <button
              ...
              className={`inline-flex shrink-0 items-center gap-1 rounded-lg border px-2.5 py-1 text-[11px] font-semibold transition-colors ${
                active
      ...
      <div
        className="mt-5 overflow-hidden rounded-lg border border-zinc-200/80 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-950"
        aria-live="polite"
      >
